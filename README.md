# PxlPop
## Intro
In de [vorige opdracht](https://github.com/PXL-CSMobile/PxlPop-ViewsAndStyles) werden de verschillende *ContentPages* van de nodige *Views* voorzien. In dit deel zullen we de applicatie voorzien van een *CollectionView* en een *TableView*
